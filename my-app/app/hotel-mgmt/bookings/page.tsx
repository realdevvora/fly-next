...
import HotelSearchForm from '../../../components/HotelBookingSearchForm';

/**
 * Hotel booking content component - displays the actual booking UI
 */
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="mt-2 text-lg text-gray-600 dark:text-gray-300">
                View your hotel's bookings based on dates and room types
              </p>
            </div>
...
const HotelBookingPage: React.FC = () => {
  ...
  // Only render the hotel booking content if authenticated
  return <HotelBookingContent />;
};
